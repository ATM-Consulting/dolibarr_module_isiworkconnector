...
setup_print_input_form_part('FINANCEMENT_URL_ZEENDOC_LOGIN', $langs->trans('FINANCEMENT_URL_ZEENDOC_LOGIN'), '', $params);

$params = ['type'=>'password', 'placeholder' => '*******'];
setup_print_input_form_part('FINANCEMENT_URL_ZEENDOC_PASSWORD', $langs->trans('FINANCEMENT_URL_ZEENDOC_PASSWORD'), '', $params);

$params = ['type'=>'text', 'placeholder' => ''];
setup_print_input_form_part('FINANCEMENT_URL_ZEENDOC_URLCLIENT', $langs->trans('FINANCEMENT_URL_ZEENDOC_URLCLIENT'), '', $params);

$params = ['type'=>'url', 'placeholder' => 'https://armoires.Zeendoc.com/_WebServices/Upload/0_3'];
setup_print_input_form_part('FINANCEMENT_URL_ZEENDOC_SERVICE_URL_BASE', $langs->trans('FINANCEMENT_URL_ZEENDOC_SERVICE_URL_BASE'), '', $params);

$params = ['type'=>'text', 'placeholder' => "nom du classeur"];
setup_print_input_form_part('FINANCEMENT_URL_ZEENDOC_CLASSEUR', $langs->trans('FINANCEMENT_URL_ZEENDOC_CLASSEUR'), '', $params);

$params = ['type'=>'text', 'placeholder' => "Source de documents"];
setup_print_input_form_part('FINANCEMENT_URL_ZEENDOC_IDSOURCE', $langs->trans('FINANCEMENT_URL_ZEENDOC_IDSOURCE'), '', $params);
